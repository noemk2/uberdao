...
export function get_vote_score(): i32 {
	assert_contract_is_initialized()
	return Proposal.get().vote_score
}
...
export function get_recent_comments(): Array<Comment> {
	assert_contract_is_initialized()
	return Proposal.recent_comments()
}
...
function is_creator(): bool {
	return context.predecessor == Proposal.get().creator
}
